...
```bash
curl -X GET "https://api.Helix.com/api/v1/rto/events?page=1&returnStatus=in_transit" \
...
```bash
curl -X GET "https://api.Helix.com/api/v1/rto/events/rto123" \
  -H "Authorization: Bearer your_token_here"
```
...
```bash
curl -X POST "https://api.Helix.com/api/v1/rto/trigger" \
  -H "Authorization: Bearer your_token_here" \
...
```json
{
  ...
  "images": [
    "https://storage.Helix.com/qc/item123_1.jpg",
    "https://storage.Helix.com/qc/item123_2.jpg"
  ]
}
```
...
```bash
curl -X POST "https://api.Helix.com/api/v1/rto/events/rto123/qc" \
  -H "Authorization: Bearer your_token_here" \
  -H "Content-Type: application/json" \
  -d '{
    "passed": true,
    "remarks": "Item in good condition",
    "images": ["https://storage.Helix.com/qc/item123.jpg"]
  }'
```

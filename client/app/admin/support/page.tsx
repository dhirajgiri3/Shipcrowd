                ...
                {filteredTickets.map((ticket) => (
                    <Card
                        ...
                        className={cn(
                            ...
                            ticket.priority === 'low' && "border-l-gray-300"
                        )}
                            ...
                            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                                <div className="flex-1 space-y-2">
                                    <div className="flex items-center gap-2 flex-wrap">
                                        <code className="text-xs font-mono text-gray-400">{ticket.id}</code>
                    ...
                    <Card className="w-full max-w-2xl max-h-[80vh] overflow-y-auto">
                        ...
                        <CardContent className="space-y-4 pt-4">
                            ...
                            <div className="space-y-4">
                                <div className="bg-gray-50 rounded-lg p-4">
                                    <div className="flex items-center gap-2 mb-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-400">{selectedTicket.createdAt}</p>
                                        </div>
                                    </div>
                                ...
                                <div className="bg-[#2525FF]/5 rounded-lg p-4 ml-8">
                                    <div className="flex items-center gap-2 mb-2">

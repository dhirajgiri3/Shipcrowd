...
import { usePricePreview } from '@/src/core/api/hooks/admin/pricing/usePricePreview';
import { cn } from '@/src/lib/utils';
import { useState } from 'react';

export function PricePreviewClient() {
    const { formData, updateFormData, companies, loading, result, handleCalculate } = usePricePreview();
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => updateFormData({ fromPincode: e.target.value })}
                                        />
                                    </div>
                                    <div className="relative">
                                        <MapPin className="absolute left-3 top-2.5 h-4 w-4 text-[var(--text-muted)]" />
                                        <Input
                                            ...
                                            onChange={(e) => updateFormData({ toPincode: e.target.value })}
                                        />
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    ...
                                    <div className="relative">
                                        ...
                                        <Input
                                            ...
                                            onChange={(e) => updateFormData({ orderValue: e.target.value })}
                                        />
                                    </div>
                                </div>
                                <div className="flex gap-2">
                                    <Input placeholder="L" className="bg-[var(--bg-elevated)] text-center text-xs" value={formData.length} onChange={e => updateFormData({ length: e.target.value })} />
                                    <Input placeholder="W" className="bg-[var(--bg-elevated)] text-center text-xs" value={formData.width} onChange={e => updateFormData({ width: e.target.value })} />
                                    <Input placeholder="H" className="bg-[var(--bg-elevated)] text-center text-xs" value={formData.height} onChange={e => updateFormData({ height: e.target.value })} />
                                </div>
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex bg-[var(--bg-tertiary)] p-1 rounded-lg">
                                    {['prepaid', 'cod'].map((mode) => (
                                        <button
                                            key={mode}
                                            onClick={() => updateFormData({ paymentMode: mode as 'prepaid' | 'cod' })}
                                            className={cn(
                            ...
                            <div className="pt-4 border-t border-[var(--border-subtle)]">
                                ...
                                <div className="mt-3 flex items-center gap-2">
                                    <input
                                        ...
                                        onChange={(e) => updateFormData({ strict: e.target.checked })}
                                    />
                        ...
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div className="rounded-xl border border-[var(--border-default)] overflow-hidden">
                                ...
                                >
                                    ...
                                    <ChevronRight className={cn("h-4 w-4 opacity-50 transition-transform", showDebug ? "rotate-90" : "")} />
                                </button>
                                {showDebug && (
                                    <div className="bg-[var(--bg-contrast)] p-4 overflow-x-auto">
                                        <pre className="text-[10px] font-mono text-[var(--success)] leading-relaxed">

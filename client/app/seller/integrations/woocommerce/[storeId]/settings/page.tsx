...
export default function WooCommerceSettingsPage() {
    ...
    const handleDeleteStore = () => {
        deleteStore({ integrationId: storeId, type: 'WOOCOMMERCE' }, {
            onSuccess: () => {
    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto p-4 sm:p-6 md:p-8">
            ...
            <ConfirmDialog
                ...
                description={`Are you sure you want to disconnect ${store?.storeName || 'this store'}? This will stop all automatic syncs, remove webhook connections, and disable order status updates. This action cannot be undone.`}

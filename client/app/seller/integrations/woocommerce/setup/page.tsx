                        ...
                        <div className="space-y-3">
                            <Button
                                ...
                                className={testResult
                                    ? 'w-full h-11 sm:h-12 border border-[#96588A]/40 text-[#7D4873] bg-transparent hover:bg-[#96588A]/10'
                                    : 'w-full h-11 sm:h-12 bg-[#96588A] hover:bg-[#7D4873] text-white'
                                }
                ...
                <div className="border-t border-[var(--border-subtle)] bg-[var(--bg-primary)] p-4 sm:p-6">
                    <div className="flex flex-col-reverse sm:flex-row gap-3 sm:gap-4">
                        ...
                        <Button
                            ...
                            className="flex-1 h-11 sm:h-12 bg-[#96588A] hover:bg-[#7D4873] text-white font-medium"
                        >
                            {isCreating ? (
                                <div className="flex items-center gap-2">
                                    <Loader2 className="w-4 h-4 animate-spin" />

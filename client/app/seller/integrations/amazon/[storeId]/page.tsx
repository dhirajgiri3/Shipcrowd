...
export default function AmazonStorePage() {
    ...
    const handleSyncNow = () => {
        triggerSync(
            { integrationId: storeId, type: 'AMAZON', syncType: 'orders' },
            {
                onSuccess: () => {
    ...
    return (
        <>
            <IntegrationStoreLayout
                platform="amazon"
                platformMeta={PLATFORM_META.amazon}
                store={store}
                storeId={storeId}
                ...
                isSyncing={isSyncing}
            >
                <IntegrationStatsGrid store={store} platformMeta={PLATFORM_META.amazon} />
            ...
            <ConfirmDialog
                ...
                onConfirm={() => {
                    disconnectStore(
                        { integrationId: storeId, type: 'AMAZON' },
                        {
                            onSuccess: () => {

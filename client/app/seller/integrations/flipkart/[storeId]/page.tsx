...
export default function FlipkartStorePage() {
    ...
    const handleSyncNow = () => {
        triggerSync(
            { integrationId: storeId, type: 'FLIPKART', syncType: 'orders' },
            {
                onSuccess: () => {
    ...
    return (
        <>
            <IntegrationStoreLayout
                platform="flipkart"
                platformMeta={PLATFORM_META.flipkart}
                store={store}
                storeId={storeId}
                ...
                isSyncing={isSyncing}
            >
                <IntegrationStatsGrid store={store} platformMeta={PLATFORM_META.flipkart} />
            ...
            <ConfirmDialog
                ...
                onConfirm={() => {
                    disconnectStore(
                        { integrationId: storeId, type: 'FLIPKART' },
                        {
                            onSuccess: () => {

...
import { Warehouse, MapPin, Package, Plus, Settings } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in fade-in duration-500">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500 text-sm mt-1">Manage pickup locations and inventory</p>
                </div>
                            ...
                            <div className="space-y-3">
                                <div>
                                    <div className="flex justify-between text-xs mb-1">
                                        ...
                                        <span className="font-medium text-[var(--text-primary)]">{Math.round((wh.utilized / wh.capacity) * 100)}%</span>
                                    </div>

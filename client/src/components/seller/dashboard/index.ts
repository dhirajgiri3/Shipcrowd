/**
 * Dashboard Components - Export all dashboard components
 * Research-backed design: Cognitive load reduction, progressive disclosure
 */

// Main Dashboard Components
export { UrgentActionsBar } from './UrgentActionsBar';
export { PerformanceBar } from './PerformanceBar';
export { OrderTrendChart } from './OrderTrendChart';
export { ShipmentPipeline } from './ShipmentPipeline';

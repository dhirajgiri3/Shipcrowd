...
export function OrderTrendChart({ data, onDataPointClick, className = '' }: OrderTrendChartProps) {
  ...
  return (
    <motion.div
      ...
      className={`rounded-3xl p-4 md:p-8 shadow-md bg-[var(--bg-primary)] border border-[var(--border-subtle)] ${className}`}
    >
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4 md:mb-6">
        ...
        <div className="flex items-center justify-between md:justify-start gap-3 md:gap-4">
          ...
          <div className={`flex items-center gap-1.5 px-2.5 md:px-3 py-1.5 rounded-lg ${
            trend === 'up' ? 'bg-[var(--success-bg)] text-[var(--success)]' :

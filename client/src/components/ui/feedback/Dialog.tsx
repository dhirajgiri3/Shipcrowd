...
>(({ className, children, overlayClassName, hideClose, ...props }, ref) => (
    <DialogPortal>
        ...
        >
            {children}
            {!hideClose && (
                <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md text-[var(--text-tertiary)] transition-colors hover:text-[var(--text-primary)] focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--primary-blue)]/30 focus-visible:ring-offset-2 disabled:pointer-events-none">
                    <X className="h-4 w-4" />

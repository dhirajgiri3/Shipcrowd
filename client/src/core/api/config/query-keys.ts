...
export const queryKeys = {
  ...
  disputes: {
    ...
    platformMetrics: (filters?: DateRangeParams) => ['disputes', 'platformMetrics', filters],
  },
  ...
  cod: {
    ...
    analytics: (filters?: DateRangeParams) => ['cod', 'analytics', filters],
  ...
  analytics: {
    ...
    adminInsights: () => ['analytics', 'dashboard', 'admin', 'insights'],
  ...
  ndr: {
    ...
    metrics: (filters?: DateRangeParams) => ['ndr', 'metrics', filters],

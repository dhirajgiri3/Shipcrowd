...
import { IInventory } from '@/infrastructure/database/mongoose/models/Inventory';
import { IStockMovement } from '@/infrastructure/database/mongoose/models/StockMovement';

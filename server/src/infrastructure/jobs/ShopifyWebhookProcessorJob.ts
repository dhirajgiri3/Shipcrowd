...
import WebhookEvent from '../database/mongoose/models/WebhookEvent';
import ShopifyWebhookService from '../../core/application/services/shopify/ShopifyWebhookService';
...
export class ShopifyWebhookProcessorJob {
  ...
  static async initialize(): Promise<void> {
    ...
    this.logger.info('Shopify webhook processor worker initialized');
  }
